        ...
        <div class="px-6 py-5 space-y-6">
          ...
          <div>
            ...
            <div class="space-y-4">
              ...
              <div>
                <label for="email-settings" class="block text-sm font-medium text-gray-700 mb-1">
                  Email
                </label>
                <input
                  id="email-settings"
...
const saveSettings = () => {
  console.log('Saving settings:', { profile: profile.value, preferences: preferences.value })
